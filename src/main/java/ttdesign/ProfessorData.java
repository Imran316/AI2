...
public class ProfessorData extends javax.swing.JFrame {
     ...
     ArrayList<ProfessorInfo> professors;
     ProfessorInfo prof;
     ResultSet rs;
    Firedata firedata;
    ...
    public ProfessorData()  {
        ...
        professors = new ArrayList<ProfessorInfo>();
        prof = new ProfessorInfo();
        try {
            firedata = new Firedata();
            professors = firedata.retriveProfessor();
        } catch (Exception e){
            System.out.println(e.toString());
        }
        professors.forEach(m ->{
            model.insertRow(model.getRowCount(), new String[]{m.getId(),m.getProfName(),m.getMobNo()});
        });
    }
    ...
    private void jButtonUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonUpdateMouseClicked
        ...
        try {
            firedata.deleteProfessor(profDel);
            firedata.addProfessor(jTextFieldID.getText(),
                    jTextFieldName.getText(),
                    jTextFieldMobile.getText());
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this,"Data Couldn't Updated");
        }
        ...
        if(!jTextFieldID.getText().isEmpty() && !jTextFieldName.getText().isEmpty() && !jTextFieldMobile.getText().isEmpty())
        {
            try {
                firedata.addProfessor(jTextFieldID.getText(),
                        jTextFieldName.getText(),
                        jTextFieldMobile.getText());
                model.insertRow(model.getRowCount(), new String[]{jTextFieldID.getText(),
                        jTextFieldName.getText(),jTextFieldMobile.getText()});
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this,"Data Couldn't Added");
            }
    ...
    private void jButtonNextActionPerformed(java.awt.event.ActionEvent evt) {
        SubjectData loginForm  =  new SubjectData();
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        firedata.deleteProfessor((String)model.getValueAt(jTableProf.getSelectedRow(), 1));
    ...
    private void jTableProfMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableProfMouseClicked
        ...
        profDel = (String)model.getValueAt(jTableProf.getSelectedRow(), 1);
